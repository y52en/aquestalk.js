...
export class AquesTalk {
  ...
  run(koe: string, speed: number = 100) {
    ...
    console.log(`DEBUG: Starting emulation: EIP=0x${emu.get_eip().toString(16)}, until=0x${return_fn_addr.toString(16)}, ESP=0x${reg_read_uint32(emu, REG_ESP).toString(16)}`);
